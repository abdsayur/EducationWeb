...
<div class="section-banner"
    style="background-image: url('{{ Storage::disk('banner-section-image')->url($banner->professor_service_image) }}')">
    <div class="container">
        <div class="banner-spacing">
            <div class="section-info">
                <h2 data-aos="fade-up" data-aos-delay="100">{!! Str::limit($banner->professor_service_title, 20) !!}
                </h2>
                <p data-aos="fade-up" data-aos-delay="200">{!! Str::limit($banner->professor_service_description, 100)
                    !!}
                </p>
            </div>
        </div>
